...
?>
<a href="?tab=pending&action=approve&id=<?= $_SESSION['org_id'] ?>" onclick="return confirm('Bạn có chắc chắn duyệt tổ chức này?');" title="Phê duyệt"><button class="group relative w-full py-5 rounded-full bg-primary text-on-primary font-bold text-lg shadow-lg shadow-primary/20 hover:shadow-primary/40 transition-all duration-400 overflow-hidden">
        ...
        <span class="relative z-10">Duyệt</span>
    </button></a>
<a href="?tab=pending&action=reject&id=<?= $org['org_id'] ?>" onclick="return confirm('Tổ chức sẽ bị xóa vĩnh viễn khỏi hệ thống. Xác nhận từ chối?');" title="Từ chối & Xóa"><button class="group relative w-full py-5 rounded-full bg-primary text-on-primary font-bold text-lg shadow-lg shadow-primary/20 hover:shadow-primary/40 transition-all duration-400 overflow-hidden">
        <div class="absolute inset-0 bg-gradient-to-r from-primary to-primary-container opacity-0 group-hover:opacity-100 transition-opacity duration-400"></div>
        <span class="relative z-10">Từ chối</span>
    </button></a>
