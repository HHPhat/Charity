...
<html lang="en">
  ...
  <head>
    ...
    <link rel="preload" href="<?php echo _HOST_URL_TEMPLATES; ?> /assets/css/adminlte.css" as="style" />
              ...
              <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                <a href="#" class="dropdown-item">
                  ...
                  <div class="d-flex">
                    <div class="flex-shrink-0">
                      <img
                        src="../assets/image/user1-128x128.jpg"
                        alt="User Avatar"
                ...
                <a href="#" class="dropdown-item">
                  ...
                  <div class="d-flex">
                    <div class="flex-shrink-0">
                      <img
                        src="../assets/image/user8-128x128.jpg"
                        alt="User Avatar"
                        class="img-size-50 rounded-circle me-3"
                      />
                    </div>
                ...
                <a href="#" class="dropdown-item">
                  ...
                  <div class="d-flex">
                    <div class="flex-shrink-0">
                      <img
                        src="../assets/image/user3-128x128.jpg"
                        alt="User Avatar"
                        class="img-size-50 rounded-circle me-3"
                      />
                    </div>
                      ...
                      <ul class="contacts-list">
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="../assets/image/user7-128x128.jpg"
                              alt="User Avatar"
                            />
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="../assets/image/user5-128x128.jpg"
                              alt="User Avatar"
                            />
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="../assets/image/user6-128x128.jpg"
                              alt="User Avatar"
                            />
