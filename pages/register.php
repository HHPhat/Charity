...
<body class="bg-background font-body text-on-background antialiased selection:bg-primary/20">
<!-- TopAppBar suppressed for transactional focus (Registration) -->
...
<!-- Editorial Left Column (Asymmetric Hero Narrative) -->
<section class="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-primary items-center justify-center p-20">
<div class="absolute inset-0 z-0">
<img class="w-full h-full object-cover opacity-40 mix-blend-overlay" data-alt="Heartwarming close-up of diverse hands joined together in a circle, soft natural lighting, editorial film aesthetic, moody blue tones" src="https://lh3.googleusercontent.com/aida-public/AB6AXuC82PpY0emUR07v2oGMvg3vu7G3wEZixretULeDp98cQ8kJm7TSavw4RCXnZQgoNUz_13-qV3DVLvsqPQz3y7BjPvkLATezz1gwv_v2w3c7nrw3OyoRXW1DmkWnq53KwgJbMTKbwWTUqfJedfvEF-6vqN8aRSsrWvNJbUJtMS3fVd62pEOqoI7PInz9xGhLs5UKIsO4LVCA-h4oNES1D5sWNIkW-LvIcVYwZrsMCaWcmtlDHF41R4KbNDBQLdGpVyzJdB0LQb3SvOau"/>
</div>
...
<div class="absolute -bottom-20 -right-20 w-80 h-80 bg-tertiary rounded-full blur-[120px] opacity-30"></div>
</section>
<!-- Registration Form Column -->
<section class="flex-1 flex flex-col justify-center items-center px-6 py-12 lg:px-24 bg-surface">
<div class="w-full max-w-md">
<!-- Mobile Logo Branding (Since TopAppBar is hidden) -->
<div class="lg:hidden mb-12 flex items-center justify-center">
...
<!-- Subtle Trust Badge -->
<div class="mt-16 pt-8 border-t border-surface-container flex items-center justify-center gap-6 opacity-60">
<div class="flex items-center gap-2">
<span class="material-symbols-outlined text-sm">shield_person</span>
<span class="text-[10px] font-label uppercase tracking-widest">Secure Encryption</span>
</div>
<div class="flex items-center gap-2">
<span class="material-symbols-outlined text-sm">verified</span>
<span class="text-[10px] font-label uppercase tracking-widest">Verified NGO</span>
</div>
</div>
</div>
</section>
</main>
<!-- Contextual Floating Transparent Guardian Widget -->
<div class="fixed bottom-8 right-8 z-40 hidden md:block">
<div class="glass-panel p-4 rounded-2xl shadow-[0_20px_40px_rgba(25,28,29,0.06)] border border-white/20 flex items-center gap-4">
<div class="w-10 h-10 bg-secondary rounded-full flex items-center justify-center text-on-secondary shadow-lg">
<span class="material-symbols-outlined" data-weight="fill">volunteer_activism</span>
</div>
<div>
<p class="text-[10px] font-label font-bold uppercase tracking-tighter text-secondary">New Impact Goal</p>
<p class="text-xs font-headline font-bold text-on-surface">Clean water for 500 families</p>
</div>
</div>
</div>
</body></html>