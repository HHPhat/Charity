...
<!-- TopAppBar Fragment (Simplified for Login) -->
...
<div class="space-y-2">
<label class="block font-label text-xs font-bold uppercase tracking-wider text-on-surface-variant px-1" for="email">Email Address</label>
<input class="w-full px-5 py-4 rounded-xl bg-surface-container-highest border-none focus:ring-2 focus:ring-primary/20 focus:bg-white transition-all duration-300 outline-none placeholder:text-outline/50" id="email" name="email" placeholder="steward@guardian.org" type="email"/>
</div>
<div class="space-y-2">
...
<div class="relative">
<input class="w-full px-5 py-4 rounded-xl bg-surface-container-highest border-none focus:ring-2 focus:ring-primary/20 focus:bg-white transition-all duration-300 outline-none placeholder:text-outline/50" id="password" name="password" placeholder="••••••••" type="password"/>
...
<!-- Floating Donation Widget (Persistent transparency anchor) -->
